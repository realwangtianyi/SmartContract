...
var Progress string //当前已筹集到的金额占预期总筹集金额的百分比进度（友好的百分比格式，公有）
var progressUnseen float32 //当前已筹集到的金额占预期总筹集金额的百分比进度（浮点数类型，私有）
...
func Give(args map[string]interface{}) (interface{}, error) {
	...
	progressUnseen = (float32)Sum / Target //重新计算百分比进度 
